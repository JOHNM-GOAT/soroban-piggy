            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: "1rem" }}>
              {quests.map((quest) => (
                <div
                  key={quest.id}
                  style={{
                    background: quest.completed ? "rgba(16, 185, 129, 0.08)" : "rgba(0, 0, 0, 0.3)",
                    border: quest.completed ? "1px solid rgba(16, 185, 129, 0.3)" : "1px solid rgba(255, 255, 255, 0.08)",
                    borderRadius: "18px",
                    padding: "1.1rem",
                    display: "flex",
                ...
                >
                  <div style={{ display: "flex", alignItems: "flex-start", gap: "0.85rem" }}>
                    ...
                    <div style={{ flex: 1 }}>
                      <div style={{ fontWeight: 700, fontSize: "0.95rem", color: quest.completed ? "#fff" : "var(--text-primary)", display: "flex", alignItems: "center", justifyContent: "space-between", gap: "0.5rem" }}>
                        <span>{quest.title}</span>
                        <span style={{ fontSize: "0.75rem", background: "rgba(99, 102, 241, 0.2)", border: "1px solid rgba(99, 102, 241, 0.4)", color: "#a5b4fc", borderRadius: "12px", padding: "2px 8px", whiteSpace: "nowrap" }}>
                          +{quest.rewardXp} XP
                        </span>
                      </div>
                ...
                {badges.map((badge) => (
                  ...
                  >
                    ...
                    <div style={{ minWidth: 0 }}>
                      <div style={{ fontWeight: 600, fontSize: "0.85rem", color: badge.unlocked ? "#fff" : "var(--text-muted)", display: "flex", alignItems: "center", gap: "4px" }}>
              ...
              {activeQuiz.quizQuestion.options.map((option, idx) => (
                <button
                  ...
                  style={{
                    ...
                    borderRadius: "14px",
                    textAlign: "left",
                    background: selectedOption === idx ? "rgba(99, 102, 241, 0.25)" : "rgba(0, 0, 0, 0.3)",
                    border: selectedOption === idx ? "1px solid rgba(99, 102, 241, 0.6)" : "1px solid rgba(255, 255, 255, 0.08)",
      ...
      {activeGameModal === "stroop" && (
        <div style={{
          ...
          <div className="glass-card" style={{ maxWidth: "460px", width: "100%", border: "1px solid rgba(0, 242, 254, 0.4)", position: "relative" }}>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "0.85rem", background: "rgba(0,0,0,0.3)", padding: "0.5rem 1rem", borderRadius: "12px" }}>
              <span style={{ fontSize: "0.85rem", fontWeight: 600, color: "var(--text-secondary)" }}>
                ⏱️ Time: <span style={{ color: stroopActive ? "#f59e0b" : "#fff", fontWeight: 700 }}>{stroopTimeLeft}s</span>
              </span>
              <span style={{ fontSize: "0.85rem", fontWeight: 600, color: "var(--text-secondary)" }}>
                🪙 Score: <span style={{ color: "#00f2fe", fontWeight: 700 }}>{stroopScore}</span> (High: {stroopHighScore})
              </span>
            </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "0.5rem", height: "200px", marginBottom: "1.25rem" }}>
              {Array.from({ length: 9 }).map((_, idx) => (
                <button
                  ...
                  style={{
                    background: stroopActive && stroopTarget === idx ? "radial-gradient(circle, rgba(0, 242, 254, 0.4) 0%, rgba(99, 102, 241, 0.2) 100%)" : "rgba(0, 0, 0, 0.25)",
                    border: stroopActive && stroopTarget === idx ? "2px solid #00f2fe" : "1px solid rgba(255, 255, 255, 0.05)",
                    borderRadius: "14px",
                    display: "flex",
                    alignItems: "center",
                    justifyContent: "center",
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "0.75rem", height: "200px", marginBottom: "1.25rem" }}>
              {[
                ...
                <button
                  ...
                  style={{
                    background: highlightKey === k.id ? k.color : "rgba(0, 0, 0, 0.3)",
                    border: highlightKey === k.id ? `2px solid ${k.color}` : "1px solid rgba(255, 255, 255, 0.08)",
                    borderRadius: "16px",
                    display: "flex",
                    flexDirection: "column",
                    alignItems: "center",
                    justifyContent: "center",
                    gap: "4px",
                    color: highlightKey === k.id ? "#000" : "#fff",
                    fontWeight: 700,
                    fontSize: "0.9rem",
